...
fullres_appsink = gst_pipeline.get_by_name("fullres_sink")
print("Appsink ", fullres_appsink)
fullres_appsink.set_property("emit-signals", True)
fullres_appsink.connect("new-sample", on_buffer, None)
